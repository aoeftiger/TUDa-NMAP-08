...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/aoeftiger/TUDa-NMAP-08/v1.0)
...
``` bash
wget https://github.com/aoeftiger/TUDa-NMAP-08/archive/refs/heads/main.zip
unzip main.zip
cd TUDa-NMAP-08-main
```
